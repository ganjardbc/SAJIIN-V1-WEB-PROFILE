...
export default {
    ...
    actions: {
        ...
        getData ({ commit, state }, data) {
            ...
            return axios.post('/api/event/getAll', params, { 
        ...
        createData ({ commit, state }, data) {
            ...
            return axios.post('/api/event/post', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        updateData ({ commit, state }, data) {
            ...
            return axios.post('/api/event/update', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        deleteData ({ commit, state }, data) {
            ...
            return axios.post('/api/event/delete', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
