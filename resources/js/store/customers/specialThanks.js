...
export default {
    ...
    actions: {
        ...
        getData ({ commit, state }, data) {
            ...
            return axios.post('/api/specialthanks/getAll', params, { 
        ...
        createData ({ commit, state }, data) {
            ...
            return axios.post('/api/specialthanks/post', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        updateData ({ commit, state }, data) {
            ...
            return axios.post('/api/specialthanks/update', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        deleteData ({ commit, state }, data) {
            ...
            return axios.post('/api/specialthanks/delete', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
        ...
        uploadCover ({ commit, state }, data) {
            ...
            params.append('specialthanks_id', data.specialthanks_id)
            params.append('image', data.image)
    
            return axios.post('/api/specialthanks/uploadImage', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
