...
export default {
    ...
    actions: {
        ...
        getData ({ commit, state }, data) {
            ...
            return axios.post('/api/comment/getAll', params, { 
        ...
        createData ({ commit, state }, data) {
            ...
            return axios.post('/api/comment/post', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        updateData ({ commit, state }, data) {
            ...
            return axios.post('/api/comment/update', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        deleteData ({ commit, state }, data) {
            ...
            return axios.post('/api/comment/delete', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
        ...
        uploadCover ({ commit, state }, data) {
            ...
            params.append('comment_id', data.comment_id)
            params.append('image', data.image)
    
            return axios.post('/api/comment/uploadImage', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
