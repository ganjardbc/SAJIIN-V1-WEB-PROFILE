        ...
        <div v-if="!visibleLoader">
            ...
            >
                ...
                <div class="padding padding-30-px">
                    <h1
                        class="fonts fonts-38px semibold black"
                        style="margin-bottom: 20px"
                    >
                        {{ data && data.title }}
                    </h1>
                    <i class="fonts fonts-14px grey" style="margin: 20px 0">{{
                        data && data.description
                    }}</i>
                    <p
                        class="fonts fonts-16px black"
                        style="margin: 20px 0"
                        v-html="data && data.content"
                    ></p>
                    <div class="display-flex" style="margin-bottom: 20px">
                        <div class="card-capsule todo">
                            {{
                                data && data.created_at | moment("DD MMMM YYYY")
                            }}
                        </div>
                    </div>
                </div>
