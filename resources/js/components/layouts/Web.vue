        ...
        <div id="header">
            <div id="header-container">
                <div class="hc-logo">
                    <router-link
                        :to="{ name: 'home' }"
                        style="position: relative; height: 40px; left: 0"
                    >
        ...
        <div id="footer">
            <div id="footer-content">
                ...
                >
                    ...
                    >
                        ...
                        <ul class="menu-list transparent">
                            ...
                            <li class="ml-list">
                                <a
                                    href="mailto:techsaji.in@gmail.com"
                                    class="ml-link"
                                >
                                    techsaji.in@gmail.com
                                </a>
                            </li>
                            <li class="ml-list">
                                <a
                                    href="mailto:sajiin.official@gmail.com"
                                    class="ml-link"
                                >
                                    techsaji.in@gmail.com
                                </a>
                ...
                >
                    ...
                    >
                        <a
                            href="https://www.instagram.com/sajiin_id/"
                            target="_blank"
                            style="margin-right: 5px"
                        >
                            <button
                                class="btn btn-icon btn-small-radius btn-sekunder"
                            >
                                <i class="fab fa-lg fa-instagram" />
                            </button>
                        </a>
                        <a
                            href="https://wa.me/6285155377009?text=Hallo admin saya mau daftarkan toko di saji-in"
                            target="_blank"
                            style="margin-right: 5px"
                        >
                            <button
